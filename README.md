...
### [Vantage-1.7.5-win-x64.zip](https://github.com/caduwinter/vantage-releases/releases/download/v1.7.5/Vantage-1.7.5-win-x64.zip)

Versão 1.7.5 · Windows 64 bits · não precisa instalar
