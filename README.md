...
### [Vantage-3.2.0-win-x64.zip](https://github.com/caduwinter/vantage-releases/releases/download/v3.2.0/Vantage-3.2.0-win-x64.zip)

Versão 3.2.0 · Windows 64 bits · extrai e roda, mas cada versão nova é manual
