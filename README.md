...
### [Vantage-1.7.4-win-x64.zip](https://github.com/caduwinter/vantage-releases/releases/download/v1.7.4/Vantage-1.7.4-win-x64.zip)

Versão 1.7.4 · Windows 64 bits · não precisa instalar
