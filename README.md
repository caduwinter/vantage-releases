...
### [Vantage-1.11.1-win-x64.zip](https://github.com/caduwinter/vantage-releases/releases/download/v1.11.1/Vantage-1.11.1-win-x64.zip)

Versão 1.11.1 · Windows 64 bits · extrai e roda, mas cada versão nova é manual
