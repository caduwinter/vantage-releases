...
### [Vantage-1.5.0-win-x64.zip](https://github.com/caduwinter/vantage-releases/releases/download/v1.5.0/Vantage-1.5.0-win-x64.zip)

Versão 1.5.0 · Windows 64 bits · não precisa instalar
